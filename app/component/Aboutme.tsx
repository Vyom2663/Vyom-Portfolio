...
export const Aboutme = () => {
  return (
    <section className="relative w-full px-4 sm:px-8 md:px-16 lg:px-24 py-16 overflow-hidden bg-white dark:bg-black text-black dark:text-white">
        ...
        <div className="flex flex-col xl:flex-row items-center sm:ml-36 gap-10">
          ...
          <div className="flex justify-center xl:justify-start">
            <Image
              ...
              alt="Profile"
              width={400}
              className="rounded-3xl h-[300px] sm:h-[400px] w-auto object-cover"
            />
          </div>
          ...
          <div className="flex flex-col items-center xl:items-start max-w-3xl w-full">
            <div className="flex flex-col md:flex-row gap-6 w-full justify-center xl:justify-start">
              ...
              <div className="flex flex-col items-center text-center p-6 border-2 border-gray-500 rounded-3xl w-full md:w-1/2">
                ...
                <p className="text-neutral-600 dark:text-neutral-300 text-lg font-serif">
                  Fresher
                </p>
                <p className="text-neutral-600 dark:text-neutral-300 text-lg font-serif">
                  React Developer
            ...
            {/* Description */}
            <p className="text-neutral-600 dark:text-neutral-300 text-sm font-serif mt-8 text-center xl:text-left">
              ...
              environments, as evidenced by relevant coursework, internships, or
              projects.
              <br />
